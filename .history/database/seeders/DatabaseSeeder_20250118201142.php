    ...
    public function run()
    {
        ...
        $products = [
            1 => [
                ...
                'description' => 'Deskripsi Kemeja Batik Pria',
            ...
            2 => [
                ...
                'description' => 'Deskripsi Dress Batik Wanita',
                'category_id' => Category::skip(2)->first()->id,
                'merchant_id' => Merchant::skip(1)->first()->id,
                'price' => 80000,
                'rating' => 0.00,
            ...
            3 => [
                'name' => 'Tas Batik',
                'description' => 'Deskripsi Tas Batik',
                'category_id' => Category::skip(2)->first()->id,
                'merchant_id' => Merchant::skip(1)->first()->id,
                'price' => 500000,
                'rating' => 0.00,
            ...
            4 => [
                ...
                'description' => 'Deskripsi Sarung Bantal Batik',
            ...
            5 => [
                'name' => 'Sepatu Batik',
                'description' => 'Deskripsi Sepatu Batik',
                'category_id' => Category::skip(8)->first()->id,
                'merchant_id' => Merchant::skip(4)->first()->id,
                'price' => 100000000,
                'rating' => 0.00,
            ...
            6 => [
                'name' => 'Dompet Batik',
                'description' => 'Deskripsi Dompet Batik',
            ...
            7 => [
                'name' => 'Topi Batik',
                'description' => 'Deskripsi Topi Batik',
                'category_id' => Category::skip(3)->first()->id,
                'merchant_id' => Merchant::first()->id,
                'price' => 450000,
                'rating' => 0.00,
            ...
            8 => [
                'name' => 'Masker Batik',
                'description' => 'Deskripsi Masker Batik',
                'category_id' => Category::skip(3)->first()->id,
                'merchant_id' => Merchant::first()->id,
                'price' => 110000,
                'rating' => 0.00,
            ...
            9 => [
                'name' => 'Payung Batik',
                'description' => 'Deskripsi Payung Batik',
            ...
            10 => [
                'name' => 'Gelang Batik',
                'description' => 'Deskripsi Gelang Batik',
                'category_id' => Category::skip(4)->first()->id,
                'merchant_id' => Merchant::skip(4)->first()->id,
                'price' => 700000,
                'rating' => 0.00,
                'status' => 'habis',
                'photo' => 'product_photos/Gelang Batik 1.jpg',
                'photo2' => 'product_photos/Gelang Batik 2.jpg',
                'photo3' => 'product_photos/Gelang Batik 3.jpg',
            ],
            11 => [
                'name' => 'Taplak Meja Batik',
                'description' => 'Deskripsi Taplak Meja Batik',
                'category_id' => Category::skip(4)->first()->id,
                'merchant_id' => Merchant::skip(4)->first()->id,
                'price' => 400000,
                'rating' => 0.00,
                'status' => 'tersedia',
                'photo' => 'product_photos/Taplak Meja Batik 1.jpg',
                'photo2' => 'product_photos/Taplak Meja Batik 2.jpg',
                'photo3' => 'product_photos/Taplak Meja Batik 3.jpg',
            ],
        ];
