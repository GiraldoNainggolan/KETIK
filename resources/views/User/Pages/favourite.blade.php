...
@section('content')
    ...
    <div class="w-full pt-20 ">
        ...
        <!-- shop wrapper -->
        <div class="container grid md:grid-cols-2 grid-cols-3 gap-6 pt-4 pb-16 items-start px-8 lg:px-40">
            <!-- sidebar -->
            ...
            <div class="col-span-4 mb-12" x-data="layoutData()">
                ...
                <div class='flex flex-col gap-4'>
                    <div :class="layout === 'grid' ? 'grid md:grid-cols-2 grid-cols-3 gap-4' : 'flex flex-col gap-4'">

                        @if ($products->count() > 0)
                            @foreach ($products as $product)
                                <div
                                    class='flex items-center p-4 bg-white border border-gray-200 dark:bg-gray-700 dark:border-gray-700 rounded-lg shadow-md'>
                                    <div class="relative ">
                                        <img src="{{ asset('storage/' . $product->photo) }}" alt="product 1"
                                    ...
                                    <div class=" 'pt-5 pb-3 px-4">
                                        <a href="#">
                                            ...
                                            @endif
                                            <h4
                                                class="uppercase dark:text-white font-bold text-xl mb-2 text-gray-800 hover:text-blue-800 transition">
                                                {{ $product->name }}</h4>
                                        </a>
                                        <div class="flex items-baseline mb-1 space-x-2">
                                            <p class="text-xl dark:text-white font-semibold">Rp
                                        ...
                                        <div class="flex flex-col gap-2 mt-4 text-black dark:text-white">
                                            <a class="flex items-center gap-2 font-medium" href="">
                                                ...
                                                <p class="text-xs font-light text-blue-800 dark:text-blue-300">
                                                    {{ $product->merchant->address }} </p>
                                            </a>
                                            <a href="">
                                                <p class="text-sm font-bold">[ {{ $product->merchant->type }} ]</p>
                            ...
                            @endforeach
                        @else
                            <h4 class="text-lg w-full text-center text-gray-500 dark:text-gray-400">There are no products.
                            </h4>
                        @endif
                    </div>
                </div>
