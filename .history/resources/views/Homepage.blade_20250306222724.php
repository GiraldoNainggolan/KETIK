    ...
    <div class="w-full ">
                            ...
                            <div class="hero-content ">
                                ...
                                @if (Auth::guard('user')->check())
                                    <a @disabled(true) href="{{ route('home') }}"
                                        class="z-12 text-white bg-[#2196F3] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center md:inline-flex items-center dark:bg-blue-600 dark:hover:bg-[#2196F3] dark:focus:ring-blue-800">Hi
                                        {{ Auth::guard('user')->user()->first_name }} </a>
                                @elseif (Auth::guard('merchant')->check())
                                    <a @disabled(true) href="{{ route('home') }}"
                                        class="z-12 text-white bg-[#2196F3] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center md:inline-flex items-center dark:bg-blue-600 dark:hover:bg-[#2196F3] dark:focus:ring-blue-800">{{ Auth::guard('merchant')->user()->owner }}
                                    </a>
                                    
                                @else
                                
                                <a href="{{ route('login') }}"
                                class="inline-block rounded-md border border-transparent bg-[#2196F3] px-7 py-3 text-base font-medium text-white transition hover:bg-opacity-90 mt-96 translate-x-[300px] translate-y-3">
                                Get Started now
                            </a>                                                                                                             
                                @endif
        ...
        <section class="pb-12 pt-20 lg:pb-[90px] lg:pt-[120px] dark:bg-dark">
            <div class="container mx-auto">
                ...
                <div class="mx-auto lg:w-[100%] w-[90%] flex flex-wrap justify-center">
                            ...
                            <div class="w-full px-4 md:w-1/4 lg:w-1/5">
                                <div class="mb-6 rounded-sm bg-white shadow-2 hover:shadow-lg dark:bg-gray-600">
                                    <div class="mb-2 flex items-center justify-center bg-white-300 dark:bg-gray-700">
                                        <img src="/assets/img/category/{{ $category->name }}.jpg"
                                ...
                                <div class="mb-6 rounded-sm bg-white  shadow-2 hover:shadow-lg  dark:bg-gray-600">
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="flex flex-col gap-2 text-black dark:text-white">
                                            ...
                                            <p href="" class="flex">
                                                <svg class="size-6 me-2" xmlns="http://www.w3.org/2000/svg"
                                                    viewBox="0 0 24 24">
                                                    <g>
                    ...
                    <div class="-mx-4 flex flex-wrap items-stretch">
                        <div class="w-full px-4">
                            <div class="mx-auto max-w-[570px] text-center sm:z-10">
                                <h2
                                    class="mb-2.5 text-3xl flex flex-col font-bold leading-snug dark:text-white md:text-[40px]">
                                    <span class="pr-0.5 text-xl lg:text-4xl">Ingin bergabung dan berdiskusi bersama user
                                        lain?</span>
                                </h2>
                                <p class="mb-6 text-base leading-relaxed dark:text-white p-5 md:pr-10">
                                    anda bisa bergabung dengan chat global kami, dan berdiskusi dengan pengguna lainnya
                                    tentang apa yang mungkin anda inginkan
                                </p>
                                @if (Auth::guard('user')->check())
                                    <a href="{{ route('global') }}"
