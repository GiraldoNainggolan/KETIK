                    ...
                    <div class="mx-6 lg:mx-20 flex flex-wrap items-center">
                        <div class="w-full px-4 lg:w-5/12">
                            <div class="hero-content ">
                                ...
                                <a href="{{ route('login') }}"
                                class="inline-block rounded-md border border-transparent bg-[#2196F3] px-7 py-3 text-base font-medium text-white transition hover:bg-opacity-90 mt-96 translate-x-[300px]">
                                Get Started now
                            </a>                            
                                @endif
